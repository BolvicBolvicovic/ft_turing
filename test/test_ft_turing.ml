...
module Sub : Turing.INPUT = struct
  ...
  let transitions =
    ...
    Turing.StateHashtbl.add ht "eraseone"
      [| ("1", "subone", "=", "LEFT"); ("-", "HALT", ".", "LEFT") |];
    Turing.StateHashtbl.add ht "subone"
      [| ("1", "subone", "1", "LEFT"); ("-", "skip", "-", "LEFT") |];
    Turing.StateHashtbl.add ht "skip"
      [| (".", "skip", ".", "LEFT"); ("1", "scanright", ".", "RIGHT") |];
    ht
end
...
module NewLanDet : Turing.INPUT = struct
  ...
  let states =
    [ "START"; "is_first"; "scanright_0"; "scanright_2"; "skip_left"; "HALT" ]
  ...
  let transitions =
    ...
    Turing.StateHashtbl.add ht "START" [| ("0", "is_first", ".", "RIGHT") |];
